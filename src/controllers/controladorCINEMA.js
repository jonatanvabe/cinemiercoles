...
let peliculas=[
    ...
    },
    {
        ...
        sinopsis:"Para las mejores amigas Becky (Grace Caroline Currey) y Hunter (Virginia Gardner), la vida consiste en conquistar los miedos y superar los límites. Pero después de escalar 600 metros hasta la cima de una remota torre de radio abandonada, se encuentran atrapadas e incomunicadas.",
        clasificacion:"+18",
        idioma:"ES",
        director:"Baltasar Kormákur",
        actores:"Idris Elba, Sharlto Copley, Leah Jeffries"
...
peliculas.forEach(function(pelicula){
    ...
    actores.textContent="Director: "+pelicula.actores
...
let estrenos=[
    {
        ...
        genero:"Suspenso",
        duracion:200,
        poster:"https://firebasestorage.googleapis.com/v0/b/cinejv-2b20d.appspot.com/o/gallo%20de%20pelea.jpg?alt=media&token=54774e22-4582-450f-a24b-584d0ea93f84",
        clasificacion:"+18",
        idioma:"ES",
        ...
        actores:"Catalina molano, Pedro Capo, Leny Velez" 
    },
    {
        nombre:"La invitacion",
        genero:"Terror",
        duracion:200,
        poster:"https://firebasestorage.googleapis.com/v0/b/cinejv-2b20d.appspot.com/o/invitacion.png?alt=media&token=5a134b8a-9cce-498b-b20c-231443b5785c",
        sinopsis:"Para las mejores amigas Becky (Grace Caroline Currey) y Hunter (Virginia Gardner), la vida consiste en conquistar los miedos y superar los límites. Pero después de escalar 600 metros hasta la cima de una remota torre de radio abandonada, se encuentran atrapadas e incomunicadas.",
        clasificacion:"+18",
        idioma:"ES",
        director:"Baltasar Kormákur",
    ...
    },
    {
        ...
        genero:"Suspenso",
        duracion:200,
        poster:"https://firebasestorage.googleapis.com/v0/b/cinejv-2b20d.appspot.com/o/pelando%20por%20mi%20vida.png?alt=media&token=5138515a-7ec0-4e49-81ee-f9bb448c46bf",
        sinopsis:"Para las mejores amigas Becky (Grace Caroline Currey) y Hunter (Virginia Gardner), la vida consiste en conquistar los miedos y superar los límites. Pero después de escalar 600 metros hasta la cima de una remota torre de radio abandonada, se encuentran atrapadas e incomunicadas.",
        clasificacion:"+18",
        idioma:"ES",
        director:"Baltasar Kormákur",
        actores:"Melisa Gomez, Stefanya Gomez, Federico ramos" 
    }
...
estrenos.forEach(function(estreno){
   ...
   //traversing (crear etiquetas de html desde js)
    ...
    let clasificacion=document.createElement("h7")
    clasificacion.classList.add("fw-bold")
    clasificacion.textContent= "clas: "+estreno.clasificacion
    ...
    let actores=document.createElement("h6")
    actores.classList.add("fw-bold")
    actores.textContent="Director: "+estreno.actores
